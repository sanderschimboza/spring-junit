...
.request
include::{snippets}/addCustomersTest/curl-request.adoc[]
...
.request
include::{snippets}/addAlreadyExistingCustomerTest/curl-request.adoc[]
...
.request
include::{snippets}/findCustomerByIdTest/curl-request.adoc[]
...
.request
include::{snippets}/findCustomerByNonExistingIdTest/curl-request.adoc[]
...
.request
include::{snippets}/findByLastNameLikeTest/curl-request.adoc[]
...
.request
include::{snippets}/findAllCustomerTest/curl-request.adoc[]
